      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            'list_node_types', 'set_pin_default_value', 'get_mod_blueprint_summary', 'list_comment_groups', 'disconnect_subgraph', 'duplicate_subgraph', 'create_config_binding_cluster'
          ],
